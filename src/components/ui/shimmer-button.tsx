    ...
    return (
      ...
      >
        ...
        <div className="-z-30 blur-[2px] absolute inset-0 overflow-visible">
          {/* spark */}
          <div className="animate-shimmer-slide absolute inset-0 aspect-[1] rounded-none [mask:none]">
        ...
        {/* backdrop */}
        <div
          className="-z-20 absolute [border-radius:var(--radius)] [background:var(--bg)]"
          style={{ inset: "var(--cut)" }}
        />
      </button>
    );
